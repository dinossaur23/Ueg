...
class ElectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create election" do
    assert_difference('Election.count') do
      post elections_url, params: { election: { code: @election.code, finish: @election.finish, init: @election.init } }
    end
  ...
  test "should update election" do
    patch election_url(@election), params: { election: { code: @election.code, finish: @election.finish, init: @election.init } }
