...
class VotersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post voters_url, params: { voter: { cpf: @voter.cpf, date_of_birth: @voter.date_of_birth, gender: @voter.gender, name: @voter.name } }
    end
  ...
  test "should update voter" do
    patch voter_url(@voter), params: { voter: { cpf: @voter.cpf, date_of_birth: @voter.date_of_birth, gender: @voter.gender, name: @voter.name } }
